...
public class LuaAnimEventEditor : Editor
{
    ...
    private int dwBoardIndex;
    private bool bActorInfoFolder = true;
    private bool bActorFolder;
    private bool bBasicFolder;
    private int dwModelID;
    ...
    private void ImportScript()
    {
        ...
        {
            ILuaState LuaApi = objAnimEvent._fileLua;
            ...
            objAnimEvent.ImportBasicInfo(-1);
            LuaApi.Pop(1);
            ...
            objAnimEvent.ImportActorInfo(-1);
            LuaApi.Pop(1);
